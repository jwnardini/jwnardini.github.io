define('emberfire/adapters/firebase', ['exports', 'ember', 'ember-data', 'emberfire/mixins/waitable', 'emberfire/utils/to-promise', 'lodash/collection/forEach', 'lodash/collection/filter', 'lodash/collection/map', 'lodash/collection/includes', 'lodash/array/indexOf', 'lodash/collection/find'], function (exports, _ember, _emberData, _emberfireMixinsWaitable, _emberfireUtilsToPromise, _lodashCollectionForEach, _lodashCollectionFilter, _lodashCollectionMap, _lodashCollectionIncludes, _lodashArrayIndexOf, _lodashCollectionFind) {
  'use strict';
  ...
  exports['default'] = _emberData['default'].Adapter.extend(_emberfireMixinsWaitable['default'], {
    ...
    getFirstEmbeddingParent: function getFirstEmbeddingParent(internalModel) {
      ...
      var embeddingParentRel = (0, _lodashCollectionFind['default'])(internalModel._implicitRelationships, function (implicitRel) {
